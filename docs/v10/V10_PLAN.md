...
4. 🔴 **HF model card** — push `lBroth/nullpii-v10-{devops,legal,medical-experimental,general,narrative,enterprise}-lora` (PT safetensors, ~3.4 MB each). Card cites unified-bench numbers + datasets used + license.
